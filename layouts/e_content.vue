<template>
    <div class="Digital_ct">       	
                            ...
                            <div class="row1_two">
                                <div class="nav">
                                    <ul>
                                        ...
                                        <nuxt-link to="/e_DigitalChina"><li><div class="nav_2">Digital China</div></li></nuxt-link>
        ...
        <div class="mfooter">Development team:Wuzheng Ningyufan Lushimei Yanxiaoqian Huangsisen</div>
