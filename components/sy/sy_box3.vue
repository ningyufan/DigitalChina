<template>
    <div class="sy_box3">
        ...
        <el-dialog  :visible.sync="sybox3_dialog1" width="60%" @close="close_dialog">
          ...
          <span>
            <video controls="controls" width="100%" src="../../assets/video/sybox3_video.mp4" type="video/mp4" id="video1" autoplay="autoplay">
            </video>
        ...
        <el-dialog :visible.sync="sybox3_dialog4" width="60%">
          <template  slot="title">
              <div class="dia_title">
               林拥军
              </div> 
        ...
        <el-dialog :visible.sync="sybox3_dialog6" width="60%">
          <template  slot="title">
              <div class="dia_title">
               数字经济和新消费成为经济发展新引擎 -- 张桂平
              </div> 
            </template>
          <span>
