<template>
  <div class="chinese-index">
		<div class="content">
			<div class="banner"></div>
			<div class="animate-box slide">
				<h2 class="animate text-h2" data-ani="fadeInUpBig" style="text-align: center">LuckLin520 Written in Chengdu</h2>
				<p class="animate text-p" data-ani="rollIn" data-delay="1000" style="text-align: center">Thank you for reading and I will continue to work hard! —————2018/08/08</p>
			</div>
			...
			<div class="animate-box slide">
				<h2 class="animate text-h2" data-ani="fadeInUpBig" style="text-align: center">做真实的自己，一切都会好起来的</h2>
				<p class="animate text-p" data-ani="slideInRight" data-delay="1000" style="text-align: center">Be true to yourself and everything will be fine</p>
			</div>
