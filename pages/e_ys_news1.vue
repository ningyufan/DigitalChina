<template>
    <div>
        <div>
            ...
            <br>
            <div class="newstext1_1_ys">Wang Zhuohua puts forward five requirements and hopes for the future development of Big Data Application Innovation Center: first, he hopes that the center can become a teaching and training base, and also provide more extensive training services for industries and enterprises in big data; second, he hopes that the center can grasp the frontier of big data development and promote the creation of big data theory. New and practical innovation; third, hope that the center can integrate with the market, develop a series of services to meet the needs of the market and enterprises, and contribute to the transformation and upgrading of the local economy; fourth, hope that the center will become an important think tank for the local government to formulate development strategies, plans and policies, and become a large number of local people to promote. According to the leader of development; Fifth, actively carry out research and project on large data standardization, and strive to become the authority of local large data system.</div>        
            <br>
            <div class="newstext1_1_ys">Xie ou, as a representative of Dawning Company, congratulated Yulin Normal University on the establishment of Dawning Big Data Application Innovation Center and Dawning Big Data Institute. He also expressed that he would actively cooperate with the school to promote the construction of Dawning College and jointly train more "big data, cloud computing" application-oriented leaders for schools, local and information industries. To develop more high-quality scientific research achievements, to promote society, to the world, and to promote the development of China's big data industry.</div>
            <br>
            <div class="newstext1_1_ys">At the ceremony, leaders such as Wang Zhuohua, Wei Guangxiong, Xie Ou and Lin Ying jointly unveiled the Yulin Normal University-Dawning Data Application Innovation Center (Yulin Normal University-Dawning Ruiyi Data Institute).</div>
