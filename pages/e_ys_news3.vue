<template>
    <div>
        ...
        <img src="@/assets/images/ysblock/news3_1_ys.jpg" height="45%" width="45%">
        <img src="@/assets/images/ysblock/news3_2_ys.jpg" height="45%" width="45%">
        ...
        <img src="@/assets/images/ysblock/news3_3_ys.jpg" height="60%" width="60%">
